...
export class ProvinsiService {
  ...
  getAllProvinsi(): Observable<any> {
    return this.http.get<any>(this.baseUrl + '/api/wilayah/getAllProvinsi' , { headers: this.httpOptions['headers'] } );
  }
  
  getProvinsiByID(id: any) {
    return this.http.get(this.baseUrl + '/api/wilayah/getProvinsiByID?id=' + id, { headers: this.httpOptions['headers'] } );
  }
