...
export class KabupatenkotaService {
  ...
  getAllKabupatenKota(id_provinsi: any): Observable<any> {
    return this.http.get<any>(this.baseUrl + '/api/wilayah/getAllKabupatenKota?id_provinsi=' + id_provinsi , { headers: this.httpOptions['headers'] } );
  }
  
  getAllKabupatenKotaByParams(id_provinsi: any, params: any): Observable<any> {
    return this.http.get<any>(this.baseUrl + '/api/wilayah/getAllKabupatenKotaByParams?id_provinsi=' + id_provinsi + '&params=' + params , { headers: this.httpOptions['headers'] } );
  }
  
  getKabupatenKotaByID(id: any) {
    return this.http.get(this.baseUrl + '/api/wilayah/getKabupatenKotaByID?id=' + id, { headers: this.httpOptions['headers'] } );
  }
